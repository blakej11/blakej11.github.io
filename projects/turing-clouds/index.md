---
image: projects/turing-clouds/images/clouds.png
---
...
four-dimensional data points. Turing clouds are an extension of Jonathan
McCabe's [Multi-Scale Turing
Patterns](http://www.jonathanmccabe.com/Cyclic_Symmetric_Multi-Scale_Turing_Patterns.pdf)
which adds smooth coloring and the heatmap visualization.

The images and videos here have all been generated by a new piece of
software I've written, called [Zounds](https://github.com/blakej11/zounds).
In this [initial version](zounds-1.00.tar.gz), it can generate Turing
clouds, multi-scale Turing patterns, and John Conway's Game of Life. It can
generate patterns quickly enough that they can be playfully interacted
with, and it provides a few different ways to have those interactions.

I have a detailed description of [how Turing clouds are
made](background.html), as well as some notes on how to set up a [dedicated
installation](standalone.html) of the software.  But you might just want to
start by seeing some.
...
[![](images/50/bw/0001667.png#center)](images/100/bw/0001667.png)
...
Some examples of color images along with the [heatmap
visualization](background.html#heatmap-visualization) of the data that
generated it.

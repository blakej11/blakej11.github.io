...
of a set of four-dimensional data points. Turing clouds are an extension of
Jonathan McCabe's [Multi-Scale Turing
...
In this initial version, it can generate Turing clouds, multi-scale Turing
patterns, and John Conway's Game of Life. It can generate patterns quickly
enough that they can be playfully interacted with, and provides a few
different ways of having those interactions.

I have a detailed description of [how they work](background.html), as well
as some notes on how to set up a [dedicated installation](standalone.html)
of it.  But you might just want to start by seeing some.
